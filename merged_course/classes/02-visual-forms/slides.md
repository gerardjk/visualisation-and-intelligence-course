...
## Colour has several jobs

Colour may encode:

- category;
- ordered magnitude;
- deviation around a midpoint;
- emphasis.
...
- inspect a deliberately messy dataset;
- specify and verify a tidy transformation;
- classify a question using the Visual Vocabulary;
- build three candidate charts;
- select one and reject one with evidence.
