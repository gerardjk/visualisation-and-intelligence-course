...
| Analytical question | Category | Chart type | Risk |
|---|---|---|---|
| Which regions have the highest values? | | | |
| How has the value changed since 2019? | | | |
| Are income and commute time related? | | | |
