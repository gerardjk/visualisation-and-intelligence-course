...
\kicker{The claim sprint}{Twelve charts · 40 seconds each.\\[0.35em]
  ...
  \credit{All figures: course reproductions, generated from data. We debrief two of them.}}
...
\sprintframe{fig-exoplanet-output-1.png}{An exoplanet transit}

% ---------- 9 · snow original ----------
\begin{frame}[t]{A picture can become an argument}\framesubtitle{Worked example · London, 1854}
  \begin{columns}[T]
    \begin{column}{0.60\textwidth}
      \includegraphics[width=\textwidth,height=0.49\textheight,keepaspectratio]{snow-original-1854.jpg}\\[0.2em]
...
\begin{frame}[t]{Pattern, inference, and the missing evidence}\framesubtitle{Worked example · London, 1854}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \includegraphics[width=\textwidth,height=0.50\textheight,keepaspectratio]{fig-snow-output-1.png}\\
...
\begin{frame}{Studio · Critique and Repair · 25 minutes}\framesubtitle{Activity sheet in activities/}
  \begin{itemize}
    \item \textbf{Draw three chart cards} (pack in activities/): for each, the claim, the audience, and one way it could mislead.
    \item \textbf{Read} the satisfaction artefact: main claim, audience, what is directly visible.
...
\begin{frame}{Close the loop}\framesubtitle{Exit ticket}
  Look back at your Critique and Repair sheet.\\
