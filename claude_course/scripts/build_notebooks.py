...
CLASSES = ROOT / "claude_course" / "classes"
...
'''),
    ...
    save(cells, CLASSES / "01-seeing-data" / "seeing_data_activities.ipynb")
...
"""),
    ...
    save(cells, CLASSES / "02-visual-forms" / "visual_forms_activities.ipynb")
