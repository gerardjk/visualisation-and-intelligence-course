...
## Assessment map (unchanged tasks, renumbered schedule)

- **A1 quizzes** — one per class; Class 4's covers both its halves.
- **A2 critique portfolio** — Critique 1 (Class 1), Critique 2 (Class 2), Critique 3 (Class 6).
- **A3 Tableau dashboard** — due after Class 3.
- **A4 public data product checkpoint** — due after Class 4.
- **A5 group Streamlit app** — final version due Class 6.
- **A6 visualisation quality review** — completed in Class 6, hour 1.
- **A7 individual oral defence** — Class 6, hour 3.
